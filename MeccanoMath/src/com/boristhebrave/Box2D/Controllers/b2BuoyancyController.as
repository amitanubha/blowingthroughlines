...
public class b2BuoyancyController extends b2MultiController
{
	...
	public static function FromBodies(bodies:Array,normal:b2Vec2 = null, offset:Number = 0, density:Number = 0):b2BuoyancyController
	{
		var c:b2BuoyancyController = new b2BuoyancyController();
		for(var i=0;i<bodies.length;i++){
			c.AddBody(bodies[i]);
		}
		if(normal!=null){
			c.normal.SetV(normal);
			c.offset = offset;
		}
		if(density>0)
			c.density = density;
