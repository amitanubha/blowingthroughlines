...
{	
	...
	*/
	...
	public function SetAxisAligned(xDamping:Number, yDamping:Number){
		T.col1.x = -xDamping;
		T.col1.y = 0;
		T.col2.x = 0;
		T.col2.y = -yDamping;
	...
	public override function Step(timestep:Number):void{
		...
		for(var i:int=0;i<m_bodies.length;i++){
			...
			//Naughty, private access
			body.m_linearVelocity.x += damping.x * timestep; 
			body.m_linearVelocity.y += damping.y * timestep;
		}
	}
	
	public static function FromBodies(bodies:Array,T:b2Mat22 = null):b2TensorDampingController
	{
		var c:b2TensorDampingController = new b2TensorDampingController();
