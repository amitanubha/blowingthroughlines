...
package
{
	 ...
	 * @author Josh Tynjala
	 */
	public class YahooCharts extends Sprite
	{
...
//			super();
	...
	//--------------------------------------
		...
		private function initializeChart():void
		{
			...
			if(this.chart.parent) this.chart.parent.removeChild(this.chart);
//			holder.addChild(this.chart);
		}
...
//			if(this.legend.parent) this.legend.parent.removeChild(this.legend);
//			holder.addChild(this.legend);
		...
		{
			var request:URLRequest = new URLRequest("chart-timeline.xml");
		...
		private function xmlLoadCompleteHandler(event:Event):void
		{
			...
			series1.setStyle("fillColor", 0x54ca22);
			...
			series2.setStyle("fillColor", 0xc82d24);
